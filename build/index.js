...
class Search {
  constructor() {
    ...
    this.openButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-trigger.js-search-trigger");
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/wp/v2/posts?search=' + this.searchField.val(), posts => {
      this.resultsDiv.html(`
        ...
        ${posts.length ? '<ul class="link-list min-list">' : '<p> No match! </p>'}
  ...
  keyPressDispatcher(e) {
    if (e.keyCode == 83 && !this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("inputm, textarea").is(":focus")) {
      this.openOverlay();
    }
